                        ...
                        <div className="col-xxl-4 col-xl-5">
                           <div className="tp-header-top-info justify-content-end">
                              ...
                              {!user && (
                                 <div className="tp-header-top-info-single">
                                    <div className="tp-header-top-info-single-btn">
                                       <Link to="/login" className="yellow-btn theme-btn"><i className="flaticon-enter"></i> Login</Link>
                                    </div>
                                 </div>
                              )}
                              ...
                              {!!user && (
                                 <div className="tp-header-top-info-single">
                                    <div className="tp-header-top-info-single-btn">
                                       <Link to="/home" className="yellow-btn theme-btn"><i className="flaticon-enter"></i> My Profile</Link>
                                    </div>
                                 </div>
                              )}
                           </div>
                     ...
                     <div className="row justify-content-xl-center align-items-center">
                        <div className="col-xl-2 col-8 tp-sticky-column">
                           <div className="tp-sticky-logo">
                              <Link to="/"><img src="src/assets/img/logo/logo_putih.png" className="img-fluid" alt="logo not found" /></Link>
                           </div>
                        </div>
                        <div className="col-xl-8 col-4">
                           <div > 
                              {/* //className="tp-main-menu-bg" */}
                              <div className="tp-main-menu ">
                                 <nav id="tp-mobile-menu">
                                    {/* <ul className="text-center">
                                       <li className="menu-item-has-children"><NavLink to="/home">Home</NavLink></li>
                                       {/* <li><NavLink to="/contact">Contact</NavLink></li> 
                                       <li><NavLink to="/password">Password</NavLink></li>
                                       <li><NavLink to="/registrasi">Register</NavLink></li>
                                       <li><NavLink to="/help">Help</NavLink></li>
                                       <li><NavLink to="/notifications">Notifications</NavLink></li>
                                       <li><NavLink to="/addmember">Add Member</NavLink></li>
                                       <li><NavLink to="/inbox">Inbox</NavLink></li>
                                       {/* <li><NavLink to="/home">Home TEST</NavLink></li> 
                                    </ul> */}
                                 </nav>
                              </div>
                        ...
                        {!user && (
                           <div className="col-xl-2 tp-sticky-column-btn">
                              <div className="tp-sticky-btn text-end">
                                 <Link to="/login" className="theme-btn justify-content-end text-white"><i className="flaticon-enter"></i> Login</Link>
                              </div>
                           </div>
                        )}
                        {!!user && (
                           <div className="col-xl-2 tp-sticky-column-btn">
                              <div className="tp-sticky-btn text-end">
                                 <Link to="/login-test" className="theme-btn justify-content-end text-white"><i className="flaticon-enter"></i> Login test</Link>
                              </div>
                           </div>
                        )}
                     </div>
